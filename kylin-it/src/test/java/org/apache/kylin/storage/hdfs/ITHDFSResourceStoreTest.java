...
public class ITHDFSResourceStoreTest extends HBaseMetadataTestCase {
    ...
    private void doTestWithPath(String path) throws Exception {
        ...
        ResourceStoreTest.testAStore(storeName, ResourceStoreTest.mockUrl("hdfs"), kylinConfig);
    ...
    public void performanceTest() throws Exception {
        ...
        ResourceStoreTest.testPerformance(hdfsStoreName, ResourceStoreTest.mockUrl("hdfs"), kylinConfig);
