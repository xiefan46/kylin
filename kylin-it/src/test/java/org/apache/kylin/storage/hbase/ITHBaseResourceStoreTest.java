...
public class ITHBaseResourceStoreTest extends HBaseMetadataTestCase {
    ...
    public void testHBaseStore() throws Exception {
        ...
        ResourceStoreTest.testAStore(storeName, ResourceStoreTest.mockUrl("hbase"), kylinConfig);
    }
    ...
    public void testHBaseStoreWithLargeCell() throws Exception {
        ...
        String oldUrl = ResourceStoreTest.replaceMetadataUrl(kylinConfig, ResourceStoreTest.mockUrl("hbase"));
